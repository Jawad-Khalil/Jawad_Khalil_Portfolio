...
window.addEventListener("scroll", function () {  // Adds an event listener for scrolling
  ...
  if (document.body.scrollTop > 20 || document.documentElement.scrollTop > 20) {  // Check if the page is scrolled down more than 20px. It checks the scrollTop property of both document.body (for Safari) and document.documentElement (for other browsers like Chrome, Firefox, IE, and Opera)
...
document
  ...
  .addEventListener("click", function (e) {  // Add a click event listener to the button
...
document.addEventListener("DOMContentLoaded", function () {  // Run when the DOM is fully loaded
